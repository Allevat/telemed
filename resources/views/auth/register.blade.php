    ...
    <div class="container-fluid" style="height: 100vh">
        <div class="row h-100">
            <div class="col-lg-7 bg-success d-lg-flex align-items-center justify-content-center cover">
                <div>
                    <h1 class="fw-bold text-center display-1">👨‍⚕️TELEMED</h1>
                    <h2 class="text-center display-6 fw-medium fst-italic">"Seus exames na palma da mão"</h2>
                    <ul class="benefits-list p-5">
                        <li class="h3 fw-medium pt-4">Gerenciamento eficaz de exames</li>
                        <li class="h3 fw-medium pt-4">Acesso rápido aos resultados</li>
                        <li class="h3 fw-medium pt-4">Interface amigável e intuitiva</li>
                        <li class="h3 fw-medium pt-4">Histórico de exames sempre disponível</li>
                        <li class="h3 fw-medium pt-4">Segurança e privacidade dos seus dados</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-5 p-lg-5 d-flex align-items-center">
                <div class="p-xs-5 p-md-5 p-lg-3 w-100">
                <h1 class="fw-bold text-center text-success display-1 pb-3 title">TELEMED</h1>
                    <h1 class="fw-bold text-success text-center">Crie a sua conta</h1>
                    @if($errors->any())
                    ...
                    <form class="py-4" action="/register" method="POST">
                        ...
                        <div class="form-floating">
                            ...
                            <div id="passwordHelp" class="form-text">A senha deve possuir no minimo 6 caracteres</div>
                        </div>
                        
                       
                        <div class="pt-3">
                            <button type="submit" class="btn btn-lg btn-success w-100">Criar Conta</button>
                        </div>
                        
                    </form>
                    <div class="text-center">
                        Já possui uma conta? <a href="">Faça login aqui</a>
                    </div>
